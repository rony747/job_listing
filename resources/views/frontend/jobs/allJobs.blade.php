...
@foreach($allJobs as $data)
        <div class="job-card">
          ...
          <div class="job-card-title">{{$data->job_title}}</div>
          ...
          <div class="job-detail-buttons">
            ...
            <button class="search-buttons detail-button"><i class="fa-solid fa-dollar-sign"></i>  @php echo number_format($data->job_salary); @endphp</button>
          </div>
          <div class="job-card-buttons">
            <a href="{{route('view.jobs', $data->id)}}"><button class="search-buttons card-buttons">View Details</button></a>
          </div>
        </div><!-- job-card -->
